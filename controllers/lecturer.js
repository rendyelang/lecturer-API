...
const getLecturerByNidn = (req, res) => {
...
const createNewLecturer = (req, res) => {
...
module.exports = {getMainPage, getAllLecturer, getLecturerByNidn, createNewLecturer, editLecturer, deleteLecturer}